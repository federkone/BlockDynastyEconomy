package BlockDynasty.repositoryOld;

import jakarta.persistence.LockModeType;
import jakarta.persistence.criteria.*;
import BlockDynasty.repository.ConnectionHandler.Hibernate.Connection;

import BlockDynasty.repositoryOld.Models.Hibernate.AccountDb;
import BlockDynasty.repositoryOld.Models.Hibernate.CurrencyDb;
...
public class RepositorySql implements IRepository
{
    ...
    @Override
    public List<Account> loadAccounts()throws TransactionException {
    ...
    public Result<TransferResult> transfer(String fromUuid, String toUuid, Currency currency, BigDecimal amount) {
        ...
        try (Session session = sessionFactory.openSession()) {
            ...
            BlockDynasty.Economy.domain.entities.account.Account from = fromDb.toEntity();
            BlockDynasty.Economy.domain.entities.account.Account to = toDb.toEntity();
