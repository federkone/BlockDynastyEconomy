...
public class PayGUI extends AccountsList {
    ...
    public PayGUI(JavaPlugin plugin, PayUseCase payUseCase, org.bukkit.entity.Player sender, GUIService guiService, SearchCurrencyUseCase searchCurrencyUseCase, MessageService messageService) {
    ...
    public void openNextSection(Player target) {
        CurrencyListPay gui = new CurrencyListPay(plugin,guiService, sender, target, searchCurrencyUseCase,payUseCase,messageService,this);
