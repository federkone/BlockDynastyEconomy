...
public class CurrencyListToWithdraw extends CurrenciesList {
    ...
    public CurrencyListToWithdraw(GUIService guiService, Player player, BlockDynasty.Economy.domain.entities.account.Player targetPlayer,SearchCurrencyUseCase searchCurrencyUseCase, WithdrawUseCase withdrawUseCase,
