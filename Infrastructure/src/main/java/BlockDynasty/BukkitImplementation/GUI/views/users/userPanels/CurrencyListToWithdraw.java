...
public class CurrencyListToWithdraw extends CurrenciesList {
    ...
    public CurrencyListToWithdraw(JavaPlugin plugin,GUIService guiService, Player player, BlockDynasty.Economy.domain.entities.account.Player targetPlayer,SearchCurrencyUseCase searchCurrencyUseCase, WithdrawUseCase withdrawUseCase,
                                  AbstractGUI parentGUI) {
        ...
        new AnvilGUI.Builder()
                .onClick((slot, stateSnapshot) -> {
                    ...
                    try {
                        ...
                        if (result.isSuccess()) {
                            sender.sendMessage(" §aRetiro exitoso");
