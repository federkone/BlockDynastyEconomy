...
import lib.templates.administrators.mainMenus.AccountPanelGUI;
import lib.templates.administrators.mainMenus.AdminPanelGUI;
import lib.templates.administrators.mainMenus.CurrencyPanelGUI;
import lib.templates.administrators.subMenus.accounts.CurrencyListToDeposit;
import lib.templates.administrators.subMenus.accounts.CurrencyListToSet;
import lib.templates.administrators.subMenus.accounts.CurrencyListToWithdraw;
import lib.templates.administrators.subMenus.accounts.EditAccountGUI;
import lib.templates.administrators.subMenus.currencies.*;
import lib.templates.users.*;
...
public class GUIFactory {
    ...
    public static void init(CurrencyUseCase currencyUseCase, AccountsUseCase accountsUseCase, TransactionsUseCase transactionsUseCase,
                            OfferUseCase offerUseCase, ITextInput textInput,AbstractGUI.PlatformAdapter adapter) {
