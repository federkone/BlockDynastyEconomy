...
public class WithdrawEvent extends Event implements SerializableEvent {
    ...
    public static WithdrawEvent fromJson(String jsonString) {
        return SerializableEvent.fromJson(jsonString, WithdrawEvent.class);
    }
}
