...
public class DepositEvent extends Event implements SerializableEvent {
    ...
    public static DepositEvent fromJson(String jsonString) {
        return SerializableEvent.fromJson(jsonString, DepositEvent.class);
    }
