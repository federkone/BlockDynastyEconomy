 ...
 */
package net.blockdynasty.economy.spigot.BukkitImplementation.Integrations.treasuryEconomy.currency;
...
public class CurrencyTreasury implements me.lokka30.treasury.api.economy.currency.Currency{
    net.blockdynasty.economy.api.entity.Currency currency;

    public CurrencyTreasury(net.blockdynasty.economy.api.entity.Currency currency ) {
