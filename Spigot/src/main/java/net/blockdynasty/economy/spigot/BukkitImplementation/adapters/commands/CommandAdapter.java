...
public class CommandAdapter implements CommandExecutor {
    private final net.blockdynasty.economy.gui.commands.abstractions.Command commandLib;

    public CommandAdapter(net.blockdynasty.economy.gui.commands.abstractions.Command command) {
