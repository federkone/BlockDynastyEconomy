...
public class VaultHook extends AbstractEconomy {
    ...
    public EconomyResponse withdrawPlayer(String player, double amount) {
        net.blockdynasty.economy.api.EconomyResponse resultWithdraw = api.withdraw(player, BigDecimal.valueOf(amount));
    ...
    public EconomyResponse depositPlayer(String player, double amount) {
        net.blockdynasty.economy.api.EconomyResponse resultDeposit = api.deposit(player, BigDecimal.valueOf(amount));
