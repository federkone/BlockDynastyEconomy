...
package net.blockdynasty.economy.spigot.BukkitImplementation.Integrations.vault2;

import net.blockdynasty.economy.api.DynastyEconomy;
import net.blockdynasty.economy.api.entity.Currency;
import net.blockdynasty.economy.spigot.BukkitImplementation.Integrations.vault.VaultHook;
...
public class Vault2Hook extends VaultHook implements EconomyMultiCurrency {
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer offlinePlayer, double amount, String currencyName) {
        net.blockdynasty.economy.api.EconomyResponse resultWithdraw = api.withdraw(offlinePlayer.getName(), BigDecimal.valueOf(amount), currencyName);
    ...
    public EconomyResponse depositPlayer(OfflinePlayer offlinePlayer, double amount, String currencyName) {
        net.blockdynasty.economy.api.EconomyResponse resultDeposit = api.deposit(offlinePlayer.getName(), BigDecimal.valueOf(amount),currencyName);
