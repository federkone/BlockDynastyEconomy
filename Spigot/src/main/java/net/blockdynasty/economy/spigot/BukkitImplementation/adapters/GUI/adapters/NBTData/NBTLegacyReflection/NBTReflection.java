package net.blockdynasty.economy.spigot.BukkitImplementation.adapters.GUI.adapters.NBTData.NBTLegacyReflection;
import org.bukkit.inventory.ItemStack;
import java.lang.reflect.Method;

//Note: this reflection class works for versions 1.9 to 1.16
public class NBTReflection {
    public static NMSVersion nmsVersion = new NMSVersion();

    @SuppressWarnings("rawtypes")
    private static Class getCraftItemstack() {
        try {
            Class c = Class.forName("org.bukkit.craftbukkit." + nmsVersion.getVersionString() + ".inventory.CraftItemStack");
            return c;
        } catch (Exception ex) {
            ex.printStackTrace();
            return null;
    ...
    private static Object getNewNBTTag() {
        try {
            Class c = Class.forName("net.minecraft.server." + nmsVersion.getVersionString() + ".NBTTagCompound");
