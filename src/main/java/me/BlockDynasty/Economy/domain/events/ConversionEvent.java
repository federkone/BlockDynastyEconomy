package me.BlockDynasty.Economy.domain.events;
...
public class ConversionEvent{//} extends Event implements Cancellable {
    ...
    public ConversionEvent(Currency exchanged, Currency received, Account account, double amountExchanged, double amountReceived) {
