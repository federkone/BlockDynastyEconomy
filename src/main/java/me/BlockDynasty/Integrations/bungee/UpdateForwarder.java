package me.BlockDynasty.Integrations.bungee;
...
public class UpdateForwarder implements PluginMessageListener {
    ...
    public UpdateForwarder() {
        this.plugin = null;
        this.getAccountUseCase =null;
    }
    ...
    public void setGetAccountUseCase( GetAccountsUseCase getAccountUseCase) {
