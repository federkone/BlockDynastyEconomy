 ...
 */
/*
package com.blockdynasty.economy.repository.ebean.Models;
...
public class CurrencyDb {
    ...
    private List<CurrencyInterchangeable> interchangeableWith = new ArrayList<>();

    @OneToMany(mappedBy = "interchangeable", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<CurrencyInterchangeable> interchangeableFrom = new ArrayList<>();
