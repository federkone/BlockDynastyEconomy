...
import net.blockdynasty.economy.minestom.commons.adapters.console.Console;
...
public class PlatformAdapter implements IPlatform {
    ...
    private IMaterialAdapter materialAdapter;

    public PlatformAdapter(boolean onlineMode, IMaterialAdapter materialAdapter) {
