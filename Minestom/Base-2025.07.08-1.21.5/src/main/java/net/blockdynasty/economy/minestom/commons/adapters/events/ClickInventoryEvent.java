...
package net.blockdynasty.economy.minestom.commons.adapters.events;

import net.blockdynasty.economy.gui.gui.GUISystem;
import net.blockdynasty.economy.gui.gui.components.ClickType;
import net.blockdynasty.economy.minestom.commons.adapters.PlayerAdapter;
import net.blockdynasty.economy.minestom.commons.adapters.inventory.MinestomInventory;
    ...
    public static void register(){
        EventNode<@NotNull InventoryEvent> eventNode = EventNode.type("clickEconomyGUI", EventFilter.INVENTORY, (event, inv) -> inv instanceof MinestomInventory)
                .addListener(InventoryPreClickEvent.class, event -> {
                    ...
                    if(tipo.equals("Left")){
                        GUISystem.handleClick(new PlayerAdapter(event.getPlayer()), ClickType.LEFT, slot);
                    }else if(tipo.equals("Right")){
                        GUISystem.handleClick(new PlayerAdapter(event.getPlayer()), ClickType.RIGHT, slot);
                    }
                })
