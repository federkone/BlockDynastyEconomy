...
package net.blockdynasty.economy.sponge.common.adapters.commands;
...
public class CommandRegister {
    ...
    public static void registerCommands(PluginContainer container,List<Command> commands) {
        ...
        for (Command command : commands) {
            registrarComando(commandRegister, container, command);
        }
    }
}