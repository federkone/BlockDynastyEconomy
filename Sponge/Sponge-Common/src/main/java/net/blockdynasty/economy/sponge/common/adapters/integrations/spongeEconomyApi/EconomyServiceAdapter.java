...
package net.blockdynasty.economy.sponge.common.adapters.integrations.spongeEconomyApi;
...
public class EconomyServiceAdapter implements MultiCurrencyService {
    ...
    public Optional<UniqueAccount> findOrCreateAccount(UUID uuid) {
        net.blockdynasty.economy.api.entity.Account response = api.getAccount(uuid);
        if (response != null) {
    ...
    public Optional<Account> findOrCreateAccount(String identifier) {
        net.blockdynasty.economy.api.entity.Account response = api.getAccount(identifier);
        if (response != null) {
            return Optional.of(new UniqueAccountAdapter(response,api));
        }
        return Optional.empty();
    ...
    public Optional<Currency> getCurrency(String currencyName) {
        net.blockdynasty.economy.api.entity.Currency response = api.getCurrency(currencyName);
        if (response != null) {
