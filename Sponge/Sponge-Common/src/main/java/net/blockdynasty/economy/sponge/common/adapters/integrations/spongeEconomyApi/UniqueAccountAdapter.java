...
import net.blockdynasty.economy.api.entity.Money;
...
public class UniqueAccountAdapter implements UniqueAccount{
    private net.blockdynasty.economy.api.entity.Account account;
    private DynastyEconomy api;

    public UniqueAccountAdapter(net.blockdynasty.economy.api.entity.Account account,DynastyEconomy api) {
