...
public class InscribirseAcategoriaPag1 extends CategoriasMenuPag1{
    private TrabajosService trabajosService;
    private PlatformGUI platformGUI;


    public InscribirseAcategoriaPag1(IEntityGUI owner, IGUI parent,TrabajosService trabajosService,PlatformGUI platformGUI) {
        super(owner, parent);
    ...
    protected void openNextPage(){
        WorkGuiFactory.inscribirseAcategoriaPag2(owner,this).open();
    }
}
