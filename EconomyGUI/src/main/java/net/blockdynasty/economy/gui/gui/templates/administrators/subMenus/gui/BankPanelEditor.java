...
package net.blockdynasty.economy.gui.gui.templates.administrators.subMenus.gui;
...
import net.blockdynasty.economy.gui.gui.templates.users.BankPanel;
...
public class BankPanelEditor extends AbstractPanel {
    ...
    @Override
    public void refresh() {
        GUIFactory.bankPanelEditor(player,getParent()).open();
    }
}
